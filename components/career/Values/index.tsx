...
const values: ValueType[] = [
  {
    title: 'Integrity',
    icon: <LocalPoliceIcon htmlColor="#00838f" />,
    subTitle: 'Do the right thing, every time.',
  },
  {
    title: 'Transparency',
    icon: <BorderClearIcon htmlColor="#00838f" />,
    subTitle: 'Be open, speak up.',
  },
  {
    title: 'Humility',
    icon: <EmojiPeopleIcon htmlColor="#00838f" />,
    subTitle: 'No egos allowed.',
  },
  {
    title: 'Meritocracy',
    icon: <StackedLineChartIcon htmlColor="#00838f" />,
