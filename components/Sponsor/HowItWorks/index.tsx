...
const HowItWorks: React.FC = () => {
  return (
    <section className={styles['how-it-works']}>
      ...
      <p>
        Summit underwrites the GP <span>to institutional standards</span>
      </p>
      ...
      <div className={styles['how-it-works-cards']}>
        <div className={styles['how-it-works-cards-small']}>
          ...
          <p>
            <span>Summit works with GP</span> to shore up shortfalls by introducing third-party service
        ...
        <div className={styles['how-it-works-cards-large']}>
          ...
          <div className={styles['how-it-works-cards-large-row']}>
            ...
            <p>
              Summit may close the asset on balance sheet and syndicate the risk or offer for best efforts
              execution
            </p>
